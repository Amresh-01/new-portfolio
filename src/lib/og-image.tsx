...
const DEFAULT_CONTENT: Required<OgImageContent> = {
  eyebrow: 'AI Native Full Stack Developer',
  title: 'Amresh',
  titleItalic: 'Chaurasiya',
  subtitle: 'Full Stack Developer @ Valoron Consulting',
  body: 'Building Fanito & scalable AI workflows.',
  stats: [
