      ...
      <div className="relative grid grid-cols-1 gap-10 md:grid-cols-[1fr_auto] md:items-start md:gap-12 lg:gap-16">
        ...
        >
          ...
          >
            ...
            . Before that,{' '}
            <span className="font-mono text-[0.95em] tabular-nums">1</span>{' '}
            years of contract and OSS work —{' '}
            <span className="font-mono text-[0.95em] tabular-nums">30+</span>{' '}
            merged PRs career-wide, mostly
            Next.js and Python.
          </p>
        ...
        >
          ...
          >
            <Image
              src="/avatar.jpg"
              alt="Portrait of Amresh Chaurasiya"
              fill
